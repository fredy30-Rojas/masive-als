# # MASIVE-ALS — Cribado Tanda 3: 1238 ligandos restantes contra TDP43_v2
#
# Descarga ligandos_tanda3.tar.gz desde GitHub (1238 ligandos de _kaggle_dataset)
...
TANDA2_URL = 'https://raw.githubusercontent.com/fredy30-Rojas/masive-als/master/_kaggle_kernel/ligandos_tanda3_clean.tar.gz'
pkg2 = '/tmp/ligandos_tanda2.tar.gz'
print('Descargando ligandos_tanda3_clean.tar.gz ...')
...
CSV = OUT_DIR + '/resultados_tanda3.csv'
CKPT = OUT_DIR + '/hechos_tanda3.txt'
...
print('Total resultados tanda 3:', len(rows))
if rows:
    best = sorted(rows, key=lambda x: float(x['energy']))[:10]
    print()
    print('Top 10 tanda 3:')
    for r in best:
        print('  ', r['ligand'], r['target'], r['energy'])
print()
print('Descargar: resultados_tanda3.csv')
