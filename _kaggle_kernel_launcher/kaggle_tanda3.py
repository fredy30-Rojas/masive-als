...
TANDA2_URL = 'https://raw.githubusercontent.com/fredy30-Rojas/masive-als/master/_kaggle_kernel/ligandos_tanda3.tar.gz'
pkg2 = '/tmp/ligandos_tanda2.tar.gz'
print('Descargando ligandos_tanda3.tar.gz ...')
